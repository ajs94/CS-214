...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;; search finds the index of a received integer   ;;
;;; Receive: aList, a list of values.              ;;
;;;          aValue, the integer searched for      ;;
;;; Return:  the integer position of aValue        ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defun Search (aList aValue count)
  (if (listp aList)
      (if (null aList)
	  (car aList)
	(if equal aValue (Search ((cdr aList count+1) aValue))
	    count
	    )
	)
    )
